...
modules/highgui/opencv_highgui_pch_dephelp.cxx: C:/opencv/sources/modules/highgui/src/precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_highgui_pch_dephelp.cxx"
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo #include \"C:/opencv/sources/modules/highgui/src/precomp.hpp\" > C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction();" >> C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction()" >> C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo { >> C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "    return 0;" >> C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\highgui && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo } >> C:/opencv-install/modules/highgui/opencv_highgui_pch_dephelp.cxx
...
modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/opencv_highgui_pch_dephelp.cxx.obj: modules/highgui/opencv_highgui_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/opencv_highgui_pch_dephelp.cxx.obj"
	cd /d C:\opencv-install\modules\highgui && C:\MinGW-64\mingw64\bin\x86_64-w64-mingw32-g++.exe   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\opencv_highgui_pch_dephelp.dir\opencv_highgui_pch_dephelp.cxx.obj -c C:\opencv-install\modules\highgui\opencv_highgui_pch_dephelp.cxx
...
modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/opencv_highgui_pch_dephelp.cxx.i: cmake_force
	...
	cd /d C:\opencv-install\modules\highgui && C:\MinGW-64\mingw64\bin\x86_64-w64-mingw32-g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E C:\opencv-install\modules\highgui\opencv_highgui_pch_dephelp.cxx > CMakeFiles\opencv_highgui_pch_dephelp.dir\opencv_highgui_pch_dephelp.cxx.i
...
modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/opencv_highgui_pch_dephelp.cxx.s: cmake_force
	...
	cd /d C:\opencv-install\modules\highgui && C:\MinGW-64\mingw64\bin\x86_64-w64-mingw32-g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S C:\opencv-install\modules\highgui\opencv_highgui_pch_dephelp.cxx -o CMakeFiles\opencv_highgui_pch_dephelp.dir\opencv_highgui_pch_dephelp.cxx.s
...
lib/libopencv_highgui_pch_dephelp.a: modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ..\..\lib\libopencv_highgui_pch_dephelp.a"
	cd /d C:\opencv-install\modules\highgui && $(CMAKE_COMMAND) -P CMakeFiles\opencv_highgui_pch_dephelp.dir\cmake_clean_target.cmake
	cd /d C:\opencv-install\modules\highgui && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\opencv_highgui_pch_dephelp.dir\link.txt --verbose=$(VERBOSE)
...
modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/clean:
	cd /d C:\opencv-install\modules\highgui && $(CMAKE_COMMAND) -P CMakeFiles\opencv_highgui_pch_dephelp.dir\cmake_clean.cmake
...
modules/highgui/CMakeFiles/opencv_highgui_pch_dephelp.dir/depend: modules/highgui/opencv_highgui_pch_dephelp.cxx
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\opencv\sources C:\opencv\sources\modules\highgui C:\opencv-install C:\opencv-install\modules\highgui C:\opencv-install\modules\highgui\CMakeFiles\opencv_highgui_pch_dephelp.dir\DependInfo.cmake --color=$(COLOR)
