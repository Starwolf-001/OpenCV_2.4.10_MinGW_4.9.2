...
modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx: C:/opencv/sources/modules/nonfree/test/test_precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_test_nonfree_pch_dephelp.cxx"
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo #include \"C:/opencv/sources/modules/nonfree/test/test_precomp.hpp\" > C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction();" >> C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction()" >> C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo { >> C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "    return 0;" >> C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	cd /d C:\opencv-install\modules\nonfree && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo } >> C:/opencv-install/modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
...
modules/nonfree/CMakeFiles/opencv_test_nonfree_pch_dephelp.dir/opencv_test_nonfree_pch_dephelp.cxx.obj: modules/nonfree/opencv_test_nonfree_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/nonfree/CMakeFiles/opencv_test_nonfree_pch_dephelp.dir/opencv_test_nonfree_pch_dephelp.cxx.obj"
	cd /d C:\opencv-install\modules\nonfree && C:\MinGW-64\mingw64\bin\x86_64-w64-mingw32-g++.exe   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\opencv_test_nonfree_pch_dephelp.dir\opencv_test_nonfree_pch_dephelp.cxx.obj -c C:\opencv-install\modules\nonfree\opencv_test_nonfree_pch_dephelp.cxx
...
lib/libopencv_test_nonfree_pch_dephelp.a: modules/nonfree/CMakeFiles/opencv_test_nonfree_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=C:\opencv-install\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ..\..\lib\libopencv_test_nonfree_pch_dephelp.a"
