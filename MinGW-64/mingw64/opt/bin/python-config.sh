...
prefix_build="/c/mingw492/x86_64-492-win32-sjlj-rt_v4-rev2/mingw64/opt"
...
CFLAGS=$(echo "-O2 -pipe -I/c/mingw492/x86_64-492-win32-sjlj-rt_v4-rev2/mingw64/opt/include -I/c/mingw492/prerequisites/x86_64-zlib-static/include -I/c/mingw492/prerequisites/x86_64-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
